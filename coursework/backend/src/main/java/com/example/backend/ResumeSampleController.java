...
public class ResumeSampleController {
     ...
     */
    @GetMapping
    public ArrayList<Resume> getResumes(@RequestParam int n, @RequestParam double rating, @RequestParam int minAge, @RequestParam int maxAge, @RequestParam String city) {
        ...
        return ResumeDAO.readSample(sessionFactory.openSession(), n, rating, minAge, maxAge, cityProcessed);
    }
}
