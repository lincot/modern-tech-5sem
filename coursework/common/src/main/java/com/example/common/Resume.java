...
public class Resume {
    ...
    @ElementCollection
    public List<PaidService> paid_services;
    @ManyToOne(cascade = CascadeType.MERGE)
    ...
    public static class Actions {
        ...
        public Download download;
        @AttributeOverrides({
                @AttributeOverride(name = "pdf.url", column = @Column(name = "download_with_contact_pdf_url")),
                @AttributeOverride(name = "rtf.url", column = @Column(name = "download_with_contact_rtf_url")),
        })
