...
public class Education {
  ...
  @ElementCollection public List<AdditionalEducation> additional;
  @ElementCollection public List<Attestation> attestation;
  @ElementCollection public List<ElementaryEducation> elementary;

  @ManyToOne(cascade = CascadeType.MERGE)
  public EducationLevel level;

  @ElementCollection public List<HigherEducation> primary;
